...
/// <summary>
/// Utility component to forward mouse or touch input to clicked gameobjects and their ancestors.
...
public class InputToEvent : MonoBehaviour
{
    ...
    private void Release(Vector2 screenPos)
    {
        if (lastGo != null)
        {
            ...
            if (currentGo == lastGo) lastGo.SendMessageUpwards("OnClick", SendMessageOptions.DontRequireReceiver);
            lastGo.SendMessageUpwards("OnRelease", SendMessageOptions.DontRequireReceiver);
            lastGo = null;
        }
    }
